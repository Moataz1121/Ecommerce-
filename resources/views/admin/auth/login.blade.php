...
<div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('admin.moataz') }}">
          @csrf
          ...
          <button class="btn btn-lg btn-primary btn-block" type="submit">Let me in as Admin</button>
